...
df$Data_type[df$Unstructured_data_language == "Non-language"] <- "Image"
...
p2 <- horizontal_bar(data_unnested, "Unstructured_data_type_unnested", 
                     string_wrap = 20, restrict_count = TRUE, 
                     title = "Free text type (Count > 1)", ylim = 60, label_text = TRUE)
...
print_tables(method_unnested, "NLP_software_unnested", "ML_type", "Traditional", top_count = 10)
```
...
## Weakly-supervised v.s. rule-based 
...
print_tables(method_unnested, "Model_performance_metrics_unnested", "ML_type", "Traditional", 
             top_count = 20, restric_count = FALSE, col_width = 4.6)
```
